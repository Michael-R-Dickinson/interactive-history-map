...
const wagadou: LocationData = {
  ...
  lifeAtLocationSection: {
    ...
    paragraphs: [
      "Wagadou's religious inclusivity is reflected in the city's layout and design. Instead of blending religious spaces with government or workplace buildings as was common in other societies, Wagadou created separation between these functions as to avoid favoring one religion over another. Religions could construct their own houses of worship and delegate these spaces for religious practice, maintaining a secular workplace or governmental environment. ",
